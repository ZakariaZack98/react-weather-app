...
const Chart = ({ data, activeMode }) => {
  return (
    <div className="chartSec p-4 rounded-xl bg-[#1B3754] w-full h-fit -translate-y-4 relative">
      ...
      <div className="w-full h-[45dvh] px-5 border border-[rgba(255,255,255,0.14)] p-2 rounded-b-xl">
        {
